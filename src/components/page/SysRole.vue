        ...
        <div class="app-container">
            <div class="box">
                <el-table :data="dataList" size="small" v-loading="listLoading"
                    ...
                    <el-table-column prop="id" align="center" label="角色id" v-if='show'/>
                    <el-table-column prop="role_name" align="center" label="角色名"/>
                    ...
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            ...
                            <el-button size="mini" type="warning" @click="handleConfig(scope.$index,scope.row)">权限配置
                            </el-button>
                ...
                <!--权限配置-->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible4Config" title="权限配置">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"
                                 label-width="50px">
                            <el-tree
                                    :data="datas"
                        ...
                        <div slot="footer" class="dialog-footer">
                            <el-button type="primary" @click="handleAdd()">确定</el-button>
                            <el-button @click="dialogFormVisible4Config = false">取消</el-button>
                        </div>
                    </el-dialog>
                </div>
                ...
                <div class="add-form" v-loading="dialogLoading">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="角色信息修改">
...
<script>
    import {addSysRoleSet, selectSysRoleSet, delSysRoleSet, editSysRoleSet} from '../../api/index.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                dialogFormVisible4Config: false,//权限配置弹窗部是否可见
                listLoading: false,       //列表加载
                dialogLoading: false,
                rules: {
                    // 校验规则
                    role_name: [{required: true, message: '角色名', trigger: 'blur'}],
        ...
        methods: {
            ...
            findPage() {
                ...
                this.listLoading = true,
                    selectSysRoleSet(param).then(res => {
                        // alert(res.size)
            ...
            handleConfig(index, row){
                // 弹出编辑窗口
                this.dialogFormVisible4Config = true;
                this.formData = Object.assign({}, row);
            },
            // 切换页码
