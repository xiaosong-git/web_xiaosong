        ...
        <div class="app-container">
            <div class="box">
                <el-table :data="dataList" size="small" v-loading="listLoading"
                    ...
                    <el-table-column prop="id" align="center" label="系统配置id" v-if='show'/>
                    <el-table-column prop="function_name" align="center" label="功能别名"/>
                    <el-table-column prop="true_name" label="功能名" align="center"/>
                    <el-table-column prop="status" label="是否启动" align="center" :formatter="stateFormat"/>
                ...
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增系统功能">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"
                            ...
                            <el-row>
                                ...
                                <el-col :span="10">
                                    <el-form-item label="功能名:" prop="true_name">
                ...
                <div class="add-form" v-loading="dialogLoading">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="系统功能修改">
                        <el-form ref="dataEditForm" :model="formData" :rules="rules" label-position="right"
                                 label-width="100px">
                            <el-row>
                                <el-col :span="10" style="display: none;">
                                    <el-form-item label="系统功能id:" prop="id">
...
<script>
    import {addSysConfigSet, selectSysConfigSet, delSysConfigSet, editSysConfigSet} from '../../api/index.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    true_name: [{required: true, message: '功能名', trigger: 'blur'}],
                }
            };
        },
        created() {
        ...
        methods: {
                ...
                this.dialogLoading = true,
                    this.$refs['dataEditForm'].validate(valid => {
                        if (valid) {
                            ...
                            editSysConfigSet(this.formData)
                                .then(res => {
            ...
            findPage() {
                ...
                this.listLoading = true,
                    selectSysConfigSet(param).then(res => {
                        // alert(res.size)
