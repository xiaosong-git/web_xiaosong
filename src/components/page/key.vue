        ...
        <div class="content-header">
            <div class="filter-container">
                <!--<el-input v-model="pagination.queryString" placeholder="登录名" style="width: 200px;"
                          class="filter-item"/>-->
                <el-input v-model="pagination.queryString" placeholder="设备编号" style="width: 200px;"
                          class="filter-item"/>
                <el-button class="dalfBut" @click="findPage()">查询</el-button>
                <el-button type="primary" class="butT" @click="handleCreate()" style="float: right">添加</el-button>
            </div>
        ...
        <div class="app-container">
            <div class="box">
                <el-table :data="dataList" size="small" v-loading="listLoading"
                    ...
                    <el-table-column prop="org_code" align="center" label="大楼编号" v-if='show'/>
                    <el-table-column prop="org_name" align="center" label="大楼名称"/>
                    <el-table-column prop="swi_code" align="center" label="上位机编号"/>
                ...
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增用户">
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"
                            ...
                            <el-row>
                                <el-col :span="10">
                                    <el-form-item label="大楼名称:" prop="org_name">
                                        <el-input v-model="formData.org_name"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="上位机编号:" prop="swi_code">
                                        <el-input v-model="formData.swi_code"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
                                    <el-form-item label="mac号:" prop="mac">
                                        <el-input v-model="formData.mac"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                    ...
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="用户信息修改">
                        <el-form ref="dataEditForm" :model="formData" :rules="rules" label-position="right"
                            ...
                            <el-row>
                                ...
                                <el-col :span="10">
                                    <el-form-item label="大楼地址:" prop="org_name">
                                        <el-input v-model="formData.org_name"/>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="10">
...
<script>
    import {addKeySet, selectKeySet, delKeySet, editKeySet} from '../../api/index.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    // 校验规则
                    mac: [{required: true, message: '用户名', trigger: 'blur'}],
                    swi_code: [{required: true, message: '用户密码', trigger: 'blur'}],
                }
            };
        },
        created() {
