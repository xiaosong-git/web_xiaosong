    ...
    <div class="app">
        <div class="content-header">
            <div class="filter-container">
                ...
                <el-button type="primary" class="butT" @click="handleCreate()" size="mini" style="float: right">添加</el-button>
            </div>
        ...
        <div class="app-container">
            <div class="box">
                ...
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增用户" width="25%" :append-to-body='true'>
                        <el-form ref="dataAddForm" :model="formData" :rules="rules" label-position="right"size="small"
                            ...
                            <el-row>
                                <el-col :span="20">
                                    <el-form-item label="授权原因:" prop="authorize_reason">
                                        <el-input v-model="formData.authorize_reason"/>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form>
                ...
                <div class="add-form" v-loading="dialogLoading">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="用户信息修改" :append-to-body='true' width="25%">
...
<script>
    import {addVipUserSet, selectVipUserSet, delVipUserSet, editVipUserSet} from '../../api/index.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    tel: [{required: true, message: '电话', trigger: 'blur'},{validator:validatePhone,trigger: 'blur'}],
                }
            };
        },
        created() {
        ...
        methods: {
            ...
            findPage() {
                ...
                this.listLoading = true,
                    selectVipUserSet(param).then(res => {
                        // alert(res.size)
