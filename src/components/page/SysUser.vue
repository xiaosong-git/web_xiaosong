    ...
    <div class="app">
        <div class="content-header">
            <div class="filter-container">
               ...
               <el-input v-model="pagination.queryString" placeholder="电话" style="width: 200px;"
                          class="filter-item"/>
                <el-button class="butT" @click="findPage()">查询</el-button>
        ...
        <div class="app-container">
            <div class="box">
                ...
                <!-- 新增标签弹层 -->
                <div class="add-form">
                    <el-dialog :visible.sync="dialogFormVisible" title="新增用户" :append-to-body='true'>
                ...
                <div class="add-form" v-loading="dialogLoading">
                    <el-dialog :visible.sync="dialogFormVisible4Edit" title="用户信息修改" :append-to-body='true'>
...
<script>
    import {addSysUserSet, selectSysUserSet, delSysUserSet, editSysUserSet,selectSysRoleByOptionSet} from '../../api/index.js'
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    tel: [{required: true, message: '电话号码', trigger: 'blur'},{validator:validatePhone,trigger: 'blur'}],
                }
            };
        },
        created() {
        ...
        methods: {
            ...
            getRole(){
                ...
                selectSysRoleByOptionSet(param).then(res => {
                    // alert(res.size)
